#+TITLE:     Ejemplo export
#+SUBTITLE:  Referencias y estilos
#+AUTHOR:    Matias Siracusa
#+EMAIL:     (concat "matias.siracusa" at-sign "pm.me")
...
# Ver settings: https://orgmode.org/manual/Export-Settings.html#Export-Settings
# Entiendo que las siguientes lineas hacen lo casi lo mismo
# #+EXPORT_FILE_NAME: ./out/exportado-propio
#+bind: org-export-publishing-directory "./out"
...
#+begin_abstract
Esto es un /abstract/ formateado con begin_abstract
#+end_abstract
...
[[http://orgmode.org/][file:images/org-mode-icon.jpg]]
...
Click to see the [[file:images/org-mode-icon.jpg][Unicorn picture]].
** Image alignment (using positioning)


#+name: test
#+begin_src python :exports results :file-ext jpg :results graphics :width 8 :height 3 :var data=tablacopada
...
""" Save the PNG file """
filename = "images/mansografico.png"
...
Por algún motivo esto no exporta en PDF.
...
#+begin_tip
Lo interesante es que un bloque ~HTML_BEGIN~ ~HTML_END~ será ignorado por el export backend.
#+end_tip
#+begin_export html
<pre style="color:red">
